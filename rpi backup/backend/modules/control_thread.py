...
class ControlSystemsThread(Thread):
    def run(self):
        ...
        while True:
            ...
            t1=time.time()
            if 'value2' in variables.sensor_data[variables.app_config["params"]["y_index"]]:
                variables.app_flags['yk'] = variables.sensor_data[variables.app_config["params"]["y_index"]]['value2']
            ...
            if (t1 - t0_control) >= variables.app_config["params"]["ts_control"]:
                t0_control = t1
            ...
            if variables.app_flags["mode"]==2:
                ...
                if (t1 - t0_ramp) >= variables.app_config["params"]["ts_ramp"]:
                    ...
                    if variables.app_aux_flags["dir_pump"] == 1:
                        if uk <= 255 - variables.app_config["params"]["du_ramp"]:
                ...
                if (t1 - t0_spab) >= variables.app_config["params"]["ts_spab"]:
                    ...
                    delta = variables.spab_data[variables.app_flags["spab_index"]] * variables.app_config["params"]["du_spab"]
